...
> **Prototype status:** TrackBus v0.1 has not been validated on real Tashkent
...
custom training, and cloud deployment are deliberately outside v0.1.
...
- Starting occupancy must be provided; v0.1 has no external source of truth.
...
TrackBus v0.1 performs ordinary person detection only. It does **not** implement
